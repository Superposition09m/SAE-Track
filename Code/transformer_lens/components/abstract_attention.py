...
class AbstractAttention(ABC, nn.Module):
    ...
    def __init__(
        ...
        To enforce implementation of W_K, W_V, b_K, and b_V by child classes, the better_abc.abstract_attribute class is used.
    ...
    def create_alibi_bias(
        ...
        Calculate the ALiBi bias (XXXX) for all heads in a layer.
